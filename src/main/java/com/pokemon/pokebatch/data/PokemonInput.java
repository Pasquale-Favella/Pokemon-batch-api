package com.pokemon.pokebatch.data;
...
public class PokemonInput {
    ...
    public String toString() {
        return "{" +
            ...
            ", against_bug='" + getAgainst_bug() + "'" +
            ", against_dark='" + getAgainst_dark() + "'" +
            ", against_dragon='" + getAgainst_dragon() + "'" +
            ", against_electric='" + getAgainst_electric() + "'" +
            ", against_fairy='" + getAgainst_fairy() + "'" +
            ", against_fight='" + getAgainst_fight() + "'" +
            ", against_fire='" + getAgainst_fire() + "'" +
            ", against_flying='" + getAgainst_flying() + "'" +
            ", against_ghost='" + getAgainst_ghost() + "'" +
            ", against_grass='" + getAgainst_grass() + "'" +
            ", against_ground='" + getAgainst_ground() + "'" +
            ", against_ice='" + getAgainst_ice() + "'" +
            ", against_normal='" + getAgainst_normal() + "'" +
            ", against_poison='" + getAgainst_poison() + "'" +
            ", against_psychic='" + getAgainst_psychic() + "'" +
            ", against_rock='" + getAgainst_rock() + "'" +
            ", against_steel='" + getAgainst_steel() + "'" +
            ", against_water='" + getAgainst_water() + "'" +
            ", attack='" + getAttack() + "'" +
            ", base_egg_steps='" + getBase_egg_steps() + "'" +
            ", base_happiness='" + getBase_happiness() + "'" +
            ", base_total='" + getBase_total() + "'" +
            ", capture_rate='" + getCapture_rate() + "'" +
            ", classfication='" + getClassfication() + "'" +
            ", defense='" + getDefense() + "'" +
            ", experience_growth='" + getExperience_growth() + "'" +
            ", height_m='" + getHeight_m() + "'" +
            ", hp='" + getHp() + "'" +
            ", japanese_name='" + getJapanese_name() + "'" +
            ", name='" + getName() + "'" +
            ", percentage_male='" + getPercentage_male() + "'" +
            ", pokedex_number='" + getPokedex_number() + "'" +
